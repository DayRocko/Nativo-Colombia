...
const SCENARIOS = [
  {
    title: 'MUSEUM',
    subtitle: 'Vitrina de Conservación',
    image: LUXURY_IMAGES.scenarioMuseum,
  },
  {
    title: 'PENTHOUSE',
    subtitle: 'Vistas Panorámicas a la Ciudad',
    image: LUXURY_IMAGES.scenarioPenthouse,
  },
  {
    title: 'YACHT MONACO',
    subtitle: 'Puerto Hércules de Mónaco',
    image: LUXURY_IMAGES.scenarioYacht,
  },
  {
    title: 'BOUTIQUE',
    subtitle: 'Via Montenapoleone Milán',
    image: LUXURY_IMAGES.scenarioBoutique,
  },
  {
    title: 'MAISON STUDIO',
    subtitle: 'Arte del Tejido Tricolor',
    image: LUXURY_IMAGES.coiledMasterpiece,
  },
  {
    title: 'LIFESTYLE',
    subtitle: 'Lino Beige & Mocasines de Gamuza',
...
export const LifestyleGallery: React.FC = () => {
  return (
    <section className="py-24 bg-[#141312] text-[#FAF8F5] border-b border-[#2C2825]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-serif-luxury text-[#FAF8F5] uppercase tracking-wide font-normal">
            Fotografía Editorial & Contexto
          </h2>
          <p className="mt-4 text-sm sm:text-base text-[#A89F91] font-light">
            Someter nuestras piezas al entorno para el cual fueron creadas: el verano europeo, la náutica de alta clase y el diseño arquitectónico de interiores.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {SCENARIOS.map((sc, idx) => (
            ...
            >
              ...
              <div className="absolute bottom-4 inset-x-4 text-center sm:text-left">
                <span className="text-[10px] uppercase tracking-[0.25em] text-[#C5A880] font-semibold block mb-0.5">
                  {sc.title}
                </span>
                <p className="text-xs font-serif text-[#FAF8F5] italic">
                  {sc.subtitle}
                </p>
              </div>
            </div>
